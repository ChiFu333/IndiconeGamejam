...
# Configuration
UNITY_PATH = "C:/Program Files/Unity/Hub/Editor/6000.0.25f1/Editor/Unity.exe"  # Path to unity editor .exe
PROJECT_PATH = "V:/GitHub/IndiconeGamejam"  # Path to unity project
...
ITCH_IO_CHANNEL = "chifu333/batteryoperator:web"  # Itch's user name and game's link name username/game:web
